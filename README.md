...
여러 기기에 맞는 사이트를 별도로 제작하지 않고 화면크기에 '반응'해 화면 요소들을 자동으로 바꾸어 사이트를 구현하는 것.
...
### **[chapter16] 플렉스 박스 레이아웃**

- `플렉스 박스 레이아웃`

부모 박스에 display:flex;를 선언하여 사용하며 플렉스 요소의 배치가 편리하여 레이아웃의 배치나 크기를 조절해야 할 때 사용하면 좋다.
